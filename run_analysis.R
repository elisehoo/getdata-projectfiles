## R Program Script to generate tidyData.txt
...
## Create  tiny data set with avg of each var for each act and each sub
uS = unique(S)[,1]
nS = length(uS)
...
## Generate the tidy file called tidyData.txt
